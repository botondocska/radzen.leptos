...
pub fn Home() -> impl IntoView {
    ...
    view! {
        ...
        <div style="max-width: 280px;">
            <RadzenDropDown
                drop_down=DropDownProps {
                    value: Some(RwSignal::new(String::new())),
        ...
        <h2 style="margin-top: 2rem;">"DropDown — Allow Clear"</h2>
        <div style="max-width: 280px;">
            <RadzenDropDown
                drop_down=DropDownProps {
                    value: Some(RwSignal::new("2".to_string())),
                    allow_clear: true,
                    data: vec![
